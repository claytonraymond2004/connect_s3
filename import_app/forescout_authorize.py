...
params = {
    "connect_s3_forescout_url": "https://fsctlab.corp.davsol.net",
...
url = params["connect_s3_forescout_url"] # Server URL
username = params["connect_s3_forescout_username"] # OIM Username
password = params["connect_s3_forescout_password"] # OIM Password
